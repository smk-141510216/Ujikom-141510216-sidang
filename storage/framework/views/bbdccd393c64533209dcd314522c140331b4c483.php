            ...
            <div class="container">
                ...
                <li class="dropdown">
                     ...
                     <li><a href="<?php echo e(url('/tunjangan_pegawai')); ?>">Index Tunjangan Pegawai   </a></li></ul>
                      ...
                      <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                              Penggajian<span class="caret"></span>
                            </a>

                            <ul class="dropdown-menu" role="menu">
                    
                     <li><a href="<?php echo e(url('/penggajian/create')); ?>">Tambah Penggajian  </a></li>
                     <li><a href="<?php echo e(url('/penggajian')); ?>">Index Penggajian </a></li></ul>
