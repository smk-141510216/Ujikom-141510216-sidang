                        ...
                        <?php echo e(csrf_field()); ?>
                         ...
                         <div class="form-group">
                            ...
                            <div class="form-group <?php echo e($errors->has('kode_jabatan') ? 'has-errors':'message'); ?>" >
                                <input id="kode_jabatan" type="text" class="form-control" name="kode_jabatan" value="<?php echo e($jabatan->kode_jabatan); ?>"  autofocus>
                            ...
                            <div class="form-group <?php echo e($errors->has('nama_jabatan') ? 'has-errors':'message'); ?>" >
                                <input id="nama_jabatan" type="text" class="form-control" name="nama_jabatan" value="<?php echo e($jabatan->nama_jabatan); ?>"  autofocus>
                            ...
                            <div class="form-group <?php echo e($errors->has('besaran_uang') ? 'has-errors':'message'); ?>" >
                                <input id="besaran_uang" type="text" class="form-control" name="besaran_uang" value="<?php echo e($jabatan->besaran_uang); ?>"  autofocus>
