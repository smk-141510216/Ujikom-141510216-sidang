                    ...
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('kategori_lembur.store')); ?>">
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="col-md-6">
                               ...
                               <div class="form-group <?php echo e($errors->has('kode_lembur') ? 'has-errors':'message'); ?>" > <input id="kode_lembur" type="text" class="form-control" name="kode_lembur" value="<?php echo e(old('kode_lembur')); ?>"  autofocus>
