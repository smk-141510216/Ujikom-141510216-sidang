                    ...
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/login')); ?>">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>> Hanya Saya
                                    </label>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.CUY', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>